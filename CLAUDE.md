...
npm run smoke      # build + handshake; asserts BASE_TOOLS in scripts/smoke.mjs (currently 42) + version == package.json
...
definitions and handlers (42 base `tools` + 4 opt-in `elevatedTools`);
