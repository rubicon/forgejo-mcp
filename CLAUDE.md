...
npm run smoke      # build + handshake; asserts BASE_TOOLS in scripts/smoke.mjs (currently 44) + version == package.json
...
definitions and handlers (44 base `tools` + 4 opt-in `elevatedTools`);
