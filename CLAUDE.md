...
npm run smoke      # build + handshake; asserts BASE_TOOLS in scripts/smoke.mjs (currently 46) + version == package.json
...
definitions and handlers (46 base `tools` + 4 opt-in `elevatedTools`);
