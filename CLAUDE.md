...
npm run smoke      # build + handshake; asserts BASE_TOOLS in scripts/smoke.mjs (currently 37) + version == package.json
...
definitions and handlers (37 base `tools` + 4 opt-in `elevatedTools`);
